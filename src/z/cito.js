    ...
    function createNode(node, domParent, parentNs, nextChild, replace, isOnlyDomChild) {
        ...
        switch (tag) {
            ...
            default:
                ...
                // ML
                var elHandlers = events && events.$el;
                if (elHandlers) {
                    triggerLight(elHandlers, '$el', domNode, node);
                }
...
// 20180531 ML: export
// 20200526 ML: $el event
// 20210624 ML: removed redundant check at 495
