...
// TODO
// 1. Переподклюбчение в комнату
// 2. если хост исчез (он обновил страницу) хостом должен стать кто-то другой
// 2.а если хоста в принципе нет и комната пуста, то стать хостом
// 3. иногда пиры отваливаются
// 4. распутать логику клиентов и хоста
// 5. отдача вопросов и мемов из списка без повторений
// 6. таблица очков
// 7. на ios карточки не поднимаются при наведении
// 8. На мобильных устройствах мелкий текст
